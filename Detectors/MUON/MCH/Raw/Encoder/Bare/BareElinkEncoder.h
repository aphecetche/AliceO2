...
class BareElinkEncoder
{
 public:
  ...
  /// is thrown.
  explicit BareElinkEncoder(uint8_t elinkId, uint8_t chip, int phase = 0,
  ...
  friend std::ostream& operator<<(std::ostream& os, const BareElinkEncoder& enc);
